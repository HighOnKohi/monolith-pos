...
import type { StaffRole, StaffStatus, AccountFilterParams } from '@/types/account'
...
export const AccountManagerFilterBar: React.FC<AccountManagerFilterBarProps> = ({
  ...
  return (
    <div className="p-3.5 rounded-2xl bg-white border border-slate-200/80 shadow-2xs space-y-3">
      {/* ── Top Row: Search & Add Account Button ── */}
      ...
      <div className="flex flex-wrap items-center justify-between gap-2.5 pt-2 border-t border-slate-100">
        ...
        {hasActiveFilters && (
          <button
            ...
            className="inline-flex items-center gap-1 px-2.5 py-1 text-xs font-bold text-rose-600 hover:text-rose-700 hover:bg-rose-50 rounded-lg transition-colors cursor-pointer"
          >
