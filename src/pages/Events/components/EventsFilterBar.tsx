      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-9 py-1.5 rounded-xl border border-slate-200 bg-slate-50/50 text-xs text-slate-800 placeholder-slate-400 focus:outline-none focus:border-slate-200 focus:bg-white transition-all font-medium"
          />
          {localSearch && (
            <button
              onClick={() => {
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 pt-1.5 border-t border-slate-100">
        ...
        <div className="ml-auto flex items-center gap-2">
          <select
            ...
            className="px-2.5 py-1 rounded-lg border border-slate-200 bg-slate-50 text-[11px] font-bold text-slate-700 focus:outline-none focus:border-slate-200 cursor-pointer"
          >
          ...
          <select
            ...
            className="px-2.5 py-1 rounded-lg border border-slate-200 bg-slate-50 text-[11px] font-bold text-slate-700 focus:outline-none focus:border-slate-200 cursor-pointer"
          >
            {(Object.keys(DATE_FILTER_LABELS) as EventFilterParams['dateFilter'][]).map((k) => <option key={k} value={k}>{DATE_FILTER_LABELS[k]}</option>)}
          </select>
