            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-2.5">
              ...
              {aggregatedItems.length === 0 ? (
                <div className="py-12 text-center text-slate-400 text-xs flex flex-col items-center gap-2">
                  ...
                  <span className="font-semibold text-slate-600">No active orders for {displayTableLabel}</span>
              ...
              <div className="space-y-2 pt-1">
                ...
                >
                  ...
                  <span>
                    {isSubmittingOrder
                      ? 'Submitting Order...'
                      : `Send Order to Kitchen (${displayTableLabel}) →`}
                  </span>
                </button>
            ...
            <div className="cashier-order-list flex-1 overflow-y-auto p-4 space-y-3">
              {pendingOrders.length === 0 ? (
                <div className="py-16 text-center text-slate-400 text-xs flex flex-col items-center gap-2">
                  ...
                  <span className="text-[11px] text-slate-400">
                    Orders submitted for {displayTableLabel} will show their live kitchen status here.
                  </span>
                </div>
              ) : (
